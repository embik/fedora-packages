# based on upstream https://github.com/alacritty/alacritty/blob/master/extra/linux/redhat/alacritty.spec
Name:          alacritty
Version:       0.4.2
Release:       1%{?dist}
...
Source:        alacritty-v%{version}.tar.gz
...
%changelog
* Sat Apr 25 2020 Marvin Beckers <mail@embik.me> 0.4.2-1
- Update to upstream release 0.4.2
- Adapt upstream spec file
